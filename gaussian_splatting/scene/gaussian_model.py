...
class GaussianModel:
    ...
    def add_points(
        ...
        # ).cuda()
        extra_f_names = []
        features_extra = np.zeros((new_xyz.shape[0], len(extra_f_names)))
        for idx, attr_name in enumerate(extra_f_names):
        ...
        # self._features_dc = torch.cat((self._features_dc, new_features_dc_rearranged), dim=0)
        # self._features_rest = torch.cat((self._features_rest, torch.zeros(new_xyz.shape[0], 0, 3, device="cuda")), dim=0)
        ...
        def print_gaussians():
            ...
            print(f"max_s: {self.max_sh_degree}")
            print(f"_xyz : {self._xyz}")
            print(f"_feat: {self._features_dc}")
            print(f"_feat: {self._features_rest}")
            print(f"_scal: {self._scaling}")
            print(f"_rota: {self._rotation}")
            print(f"_opac: {self._opacity}")
            print(f"max_r: {self.max_radii2D }")
            print(f"xyz_g: {self.xyz_gradient_accum}")
            print(f"uniqu: {self.unique_kfIDs }")
            print(f"n_obs: {self.n_obs}")
            print(f"optim: {self.optimizer}")
            print(f"scali: {self.scaling_activation}")
            print(f"scali: {self.scaling_inverse_activation}")
            print(f"covar: {self.covariance_activation}")
            print(f"opaci: {self.opacity_activation}")
            print(f"inver: {self.inverse_opacity_activation}")
            print(f"rotat: {self.rotation_activation}")
            print(f"confi: {self.config}")
            print(f"ply_i: {self.ply_input}")
            print(f"isotr: {self.isotropic}")
            print(f" shapes   ++++++++++++++++++ shapes ++++++++++++++++++++ shapes")
            print(f"_xyz : {self._xyz.shape}")
            print(f"_feat: {self._features_dc.shape}")
            print(f"_feat: {self._features_rest.shape}")
            print(f"_scal: {self._scaling.shape}")
            print(f"_rota: {self._rotation.shape}")
            print(f"_opac: {self._opacity.shape}")
            print(f"max_r: {self.max_radii2D .shape}")
            print(f"xyz_g: {self.xyz_gradient_accum.shape}")
            print(f"uniqu: {self.unique_kfIDs .shape}")
